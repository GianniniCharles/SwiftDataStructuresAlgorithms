...
func findNthSmallestInt(_ theArray: [Int], n: Int) -> Int? {
    var searchHeap = Heap(sort: <, elements: theArray)
    return searchHeap.remove(at: n)
}

findNthSmallestInt(integers, n: 0)


//Challenge 2:
let integers2 = [21, 10, 18, 5, 3, 100, 1]
var minHeap = Heap(sort: <, elements: integers2)
print(minHeap)
/* Min Heap Steps:
  make a minimum heap.
